...
You can try out this type of script by typing some mathematical operations in the script and running those lines. The output will show below, in your console panel. For example, you can try:
...
If you are using R for data analysis, you generally have existing data you'd like to analyze. 
